...
var $author$project$Main$displayBoardgame = function (boardgame) {
	return A2(
		...
		function (_v0) {
			var index = _v0.a;
			var cell = _v0.b;
			return A3($author$project$Main$displayHtmlCell, index, cell, boardgame.currentPlayer);
		},
...
var $author$project$Main$doesNoWinner = function (cells) {
...
var $author$project$Main$displayHtmlBoardgame = function (boardgame) {
	...
	if (_v0.$ === 'Nothing') {
		return $author$project$Main$doesNoWinner(boardgame.cells) ? A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Oh, there\'s no winner this time !')
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
...
var $author$project$Main$modifyCellOwner = F3(
	function (id, player, boardgame) {
		return A3(
			$elm$core$Array$set,
			id,
			{
				player: $elm$core$Maybe$Just(player)
			},
			boardgame.cells);
	});
